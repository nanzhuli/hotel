                ...
                $.post(home.urls.orderHistory.getAll, {}, function (result) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        switch (parseInt(select)) {
                            case 0:
                                flag = (JSON.stringify(data[i].orderHistoryno).indexOf(search) !== -1);
                                break;
                            case 1:
                        ...
                        if (flag) {
                            $tbody.append(
                                ...
                                "<td><a href='#' class='mores' id='more-" + data[i].orderHistoryno + "'><i class=\"layui-icon layui-icon-list\"></i></a></td>" +
                                "<td><a href='#' class='edits' id='edit-" + data[i].orderHistoryno + "'><i class=\"layui-icon layui-icon-edit\"></i></a></td>" +
                                "<td><a href='#' class='deletes' id='delete-" + data[i].orderHistoryno + "'><i class=\"layui-icon layui-icon-delete\"></i></a></td>" +
                                "<td><a href='#' class='submits' id='submit-" + data[i].orderHistoryno + "'><i class=\"layui-icon layui-icon-ok-circle\"></i></a></td>" +
                                "</tr>")
                        }
                    }
                    // 数据渲染完毕
        ...
        bindMoreEventListener: function (moreBtn) {
            ...
            moreBtn.on('click', function () {
                ...
                $.get(home.urls.orderHistory.getOne + code, {}, function (result) {
                    ...
                    layui.use('layer', function () {
                        // 使用订单号查找订单所包含的所有房间
                        $.get(home.urls.room.getAll + res.orderHistoryno, {}, function (allRoom) {
                            console.log(allRoom);
                        ...
                        layer.open({
                            ...
                            content:
                                ...
                                "<tr><td>订单号</td><td colspan='2'>" + (res.orderHistoryno) + "</td></tr>" +
